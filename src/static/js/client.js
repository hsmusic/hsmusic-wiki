...
// Artist rolling window ----------------------------------

const artistRollingWindowInfo = clientInfo.artistRollingWindowInfo = {
...
function getArtistRollingWindowReferences() {
  const info = artistRollingWindowInfo;
...
function addArtistRollingWindowPageListeners() {
  const info = artistRollingWindowInfo;
...
function mutateArtistRollingWindowPageContent() {
  updateArtistRollingWindow();
}
...
if (document.documentElement.dataset.urlKey === 'localized.artistRollingWindow') {
  clientSteps.getPageReferences.push(getArtistRollingWindowReferences);
  clientSteps.addPageListeners.push(addArtistRollingWindowPageListeners);
  clientSteps.mutatePageContent.push(mutateArtistRollingWindowPageContent);
}
